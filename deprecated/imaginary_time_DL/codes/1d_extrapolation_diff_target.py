...
# ================== GLOBAL CONFIGURATION (FINAL HYBRID) ==================
jax.config.update("jax_enable_x64", False)

RUN_NAME = "run_1d_new_target"
ENABLE_PLOTTING = True
SEED = 17

# --- Target Function Configuration ---
TARGET_N_FREQUENCIES = 8 # originally 6
TARGET_MIN_FREQ = 0.2 # originally 0.01
TARGET_MAX_FREQ = 1.5 # originally 1.0
TARGET_AMP_MIN = 0.3 # originally 0.5
TARGET_AMP_MAX = 7.0 # originally 5.0

# --- Training Configuration ---
SCHEDULER_TYPE = 'reduce_on_plateau'  # Options: 'warmup_cosine_decay', 'reduce_on_plateau'
LOSS_FUNCTION_TYPE = 'log_cosh'
...
# ================== 1. NETWORK & HELPERS (FROM REFERENCE) ==================
...
# ================== 3. NORMALIZATION (FROM REFERENCE) ==================
...
# ================== 4. LOSS FUNCTION (FROM REFERENCE) ==================
